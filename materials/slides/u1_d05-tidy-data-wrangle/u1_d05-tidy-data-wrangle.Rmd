...
## <i class="fas fa-laptop"></i> `AE 04 - Hotels + Data wrangling`
...
- Go to RStudio Cloud ([rstd.io/dsbox-cloud](http://rstd.io/dsbox-cloud)) and start `AE 04 - Hotels + Data wrangling`.
- Open the R Markdown document and complete Exercises 5 - 6.
...
- Go to RStudio Cloud ([rstd.io/dsbox-cloud](http://rstd.io/dsbox-cloud)) and start `AE 04 - Hotels + Data wrangling`.
- Open the R Markdown document and complete Exercises 7 - 8.
